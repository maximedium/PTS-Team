...
```
sudo wget -N https://raw.githubusercontent.com/eidanyosoy/PTS-Clone/final/functions/backup-keys.sh
...
sudo wget -qO- https://raw.githubusercontent.com/eidanyosoy/Install/master/install.sh | sudo bash
...
```    
### Optional - updating your PTS-Team fork to the new eidanyosoy fork
IDoMnCi came up with a great script to change all the links on an existing PTS-Team fork (NOT PG 8.x) to the eidanyosoy fork.
Details - https://github.com/eidanyosoy/Install/pull/4
```
sudo wget -qO- https://raw.githubusercontent.com/eidanyosoy/Install/master/relocate.sh | sudo bash
...
* Set up and deploy Traefik ([see here](https://github.com/eidanyosoy/PTS-Team/wiki/Traefik))   

* Close ports using Port Guard ([see here](https://github.com/eidanyosoy/PTS-Team/wiki/PTS-Port-Guard))  

* Deploy PTS Shield (GOAuth - all apps supported) [see here](https://github.com/eidanyosoy/PTS-Team/wiki/PTS-Shield)

* Set up and deploy PTS-Clone. You can restore you backup keys at this stage. [see here](https://github.com/eidanyosoy/PTS-Team/wiki/PTS-Clone)

* (Optional) Restore PTS backup (created in step 1) using PTS-Vault. [see here](https://github.com/eidanyosoy/PTS-Team/wiki/PTS-Vault---Data-Storage)

* Install desired core/community applications (Do this regardless of whether it is a fresh install with restore or overwrite)  [see here](https://github.com/eidanyosoy/PTS-Team/wiki/core-apps)

* (Optional) If overwriting/restoring, you will need to change 2 remote path mappings in applications (NZB clients / Torrent clients / radarr / sonarr / lidarr etc)    [see here](https://github.com/eidanyosoy/PTS-Team/wiki/Remote-Path-Mappings)
...
[**[Click Here]**](https://github.com/eidanyosoy/PTS-Team/wiki/Pre-Reading) to view the list!

## 6. Having Issues?

[**[Click Here]**](https://github.com/eidanyosoy/PTS-Team/wiki/Common-Issues) for more information!
